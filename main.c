...
void Case_4(TList* list){
    ...
    scanf("%d",&index);
    //list_update_elements(list,element,index);
    list_print(list_update_elements(list,element,index));
}
